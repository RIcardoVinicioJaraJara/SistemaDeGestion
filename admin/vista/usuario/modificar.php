...
<body>
    ...
    <form id="formulario01" method="POST"
        action="../../controladores/usuario/modificar.php?rol=<?php echo "$rol"; ?>&cod=<?php echo "$cod"; ?>">
        ...
        <input list="browsers" type="text" id="rol" name="rol" value="<?php echo $row["usu_rol"]; ?>" required
            placeholder="Ingrese el correo electrónico ..." />
        ...
        <input type="reset" id="cancelar" name="cancelar" value="Cancelar"
            onclick='location.href=" <?php echo "$dir";  ?>"' />
    </form>
    <?php
